...
cloud_config= {
  'secure_connect_bundle': 'secure-connect-cassandra-dem.zip'
}

with open("cassandra-demo-toke.json") as f:
    secrets = json.load(f)

CLIENT_ID = secrets["clientId"]
CLIENT_SECRET = secrets["secret"]
ASTRA_DB_KEYSPACE = "test_keyspace"
OPENAI_API_KEY = "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"
